...
/**
 * 
 * Class is used for defining information about PlayerSprite. Also contains a
 * move method for player movement.
 *
 */
public class PlayerSprite implements Spriteable {
	...
	/**
	 * Method is used to move the player by updating the players direction via using
	 * players orientation.
	 */
	public void move() {
		step(direction);
